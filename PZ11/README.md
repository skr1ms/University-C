...
### 1. Файл с записями о читателях. Запись содержит ник и идентификатор.
...
### 2. Файл с записями об учебных курсах. Запись содержит название и пояснение.
...
### 3. Файл с записями о студентах. Запись содержит имя и номер студенческого.

- Запретить чтение файла. Вывести содержимое файла на консоль.
- Разрешить чтение последней записи. Вывести содержимое файла на консоль.
- Посчитать количество доступных записей, вывести количество на консоль.

### 4. Файл с записями о книгах. Запись содержит название и количество страниц.
...
- `check_locks.c` - программа для работы с блокировкой записей файла
- `books.txt` - текстовый файл с данными о книгах
- `books.bin` - бинарный файл, создаваемый программой (временный)

## Технические детали

Программа использует механизм блокировок для управления доступом к записям файла:
- Блокировка всех записей файла
- Разблокировка конкретных записей
- Проверка статуса блокировки и подсчет доступных записей
